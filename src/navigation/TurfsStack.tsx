...
import TurfSlotsCalendarScreen from '../screens/turfs/TurfSlotsCalendarScreen';
    ...
    return (
        ...
        >
            ...
            <Stack.Screen
                ...
                options={{ title: 'My Turfs' }}
            />
            <Stack.Screen
                name="TurfSlotsCalendar"
                component={TurfSlotsCalendarScreen}
                options={{ title: 'Book Slots' }}
            />
            <Stack.Screen
                name="LocationPicker"
